        ...
        <div class="body-questions">
            ...
            <div class="choices">
                <table class="table-choices">
                    <tr>
                        <td style="width: 50%; color:{{$question->answer=="a" ? "red":""}}">a.
                            <span id="choices_a_{{$index+1}}"></span>
                        </td>
                        <td style="width: 50%; color:{{$question->answer=="b" ? "red":""}}">c.
                            <span id="choices_b_{{$index+1}}"></span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; color:{{$question->answer=="c" ? "red":""}}">b.
                            <span id="choices_c_{{$index+1}}"></span>
                        </td>
                        <td style="width: 50%; color:{{$question->answer=="d" ? "red":""}}">d.
                            <span id="choices_d_{{$index+1}}"></span>
                        </td>
                    </tr>
                </table>
